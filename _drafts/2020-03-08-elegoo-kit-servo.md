...
<div style="position:relative;padding-top:56.25%;">
  <p><iframe src="link" frameborder="0" allowfullscreen
...
1 - [Red LED](link): A standard red LED is used as a power indicator.
...
1 - [Small 5" needle nose plyers](https://amzn.to/2G003Hy) (optional): Use to resistor limages/posts/2020-03-08-arduino-micro-servo/arduino-led-encoder-servo.svgegs. More tips in the video.
...
![Materials for this project](/images/posts/2020-03-08-arduino-micro-servo/arduino-servo-encoder-materials.jpg)
...
![Fritzing project components](/images/posts/2020-03-08-arduino-micro-servo/arduino-led-encoder-servo.svg)

[Download Fritzing file](/images/posts/2020-03-08-arduino-micro-servo/arduino-led-encoder-servo.fzz).

[View/Print a Google Doc](https://docs.google.com/document/d/1zsiHF412hbn_6jT24qbFMkBAfLY20gssL4km8vUDkak/edit?usp=sharing) that contains a Fritzing construction image and code on a 2 page document.
...
[Download the code](/images/posts/2020-03-08-arduino-micro-seHopefully this project was a great way to learn more about the MEGA, the Elegoo kit components, and the Arduino IDE. I would love to read your comments. If you have any, drop them in the comments section below.rvo/encoder-servo-led-switch/encoder-sHopefully this project was a great way to learn more about the MEGA, the Elegoo kit components, and the Arduino IDE. I would love to read your comments. If you have any, drop them in the comments section below.ervo-led-switch.ino).
...
1. [In-Depth: How Rotary Encoder Works and Interface It with Arduino](https://lastminuteengineers.com/rotary-encoder-arduino-tutorial/)
