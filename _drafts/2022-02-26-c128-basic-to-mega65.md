...
That last one has now been revived by the MEGA65 developers and is now in active development for the soon to be released MEGA65. As the owner of a MEGA65 Dev Kit, I've been following development and is what caused me to want to try and port a BASIC program from my previous favorite 8-bit computer, the [Commodore 128](https://www.stevencombs.com/c128-1), to my newest 8-bit computer obsession, the [MEGA65](https://www.stevencombs.com/mega65).
