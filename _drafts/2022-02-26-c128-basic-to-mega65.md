...
Below is the BASIC program from page 116 of the [C128 Programmer's Reference Manual](https://www.stevencombs.com/_posts/c128/c128-programmers-reference-guide.pdf). I'll cover the lines of code when we compare them to the MEGA65 version. The C128 uses BASIC version 7 (more on version later).
...
![C128 Submarine Tracking System](https://www.stevencombs.com/_posts/c128/sub-track-sys.png)
...
![Compare the C128 and MEGA65 versions](https://www.stevencombs.com/_posts/c128/sub-track-sys-compare.png)
