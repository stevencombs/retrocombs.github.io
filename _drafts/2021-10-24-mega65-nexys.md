...
- [Connecting Input/Ouput (I/O) Devices](#connecting-inputouput-io-devices)
...
![Nexys4 Self-Test](https://www.stevencombs.com/images/mega65/nexys4-self-test.png)
...
![MEGA65 Utility Application Virtual Keyboard](https://www.stevencombs.com/images/mega65/virtual-keyboard-utility.png)
...
I have issues with the virtual keyboard, or *Matrix Mode Debugger* screen, appearing on the screen. The right and left side are cut off, as seen in the image above. This could be due to the way I capture the output. If readers know a solution, drop a comment below.
...
![Micro-switches](https://www.stevencombs.com/images/mega65/nexys4-board-switches.png)
