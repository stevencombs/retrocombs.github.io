...
Today, this Commodore fan-boy is going to unbox a TI 99/4. No, not that one. Nope, not that one either. But this one. This tan model is a last of the line model designed to lower the price, compete with Commodore, and save the TI computer line. Let's see what happened.
