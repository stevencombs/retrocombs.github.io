...
6. Click *Open* and the ROM update verification dialog box shown below will display.
    ...
    ![Update ROM dialog box](https://www.stevencombs.com/images/mega65/rom-update-verification.png)
    
7. Click the *OK* button and *xmega65* will reboot with the new ROM.
