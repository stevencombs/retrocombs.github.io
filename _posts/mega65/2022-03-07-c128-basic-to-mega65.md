...
1. [UPDATE: 2022-03-13] Developer Bit Shifter shares a way to use the `BOX` command with V10, to draw the border and text the way I wanted, [here](https://discord.com/channels/719326990221574164/805252939593416705/951748305845628949). I've updated this blog post to add this change. I considered a mention but this one keystroke made the V10 code operate like the V7 code and was a more accurate conversion. Since the solution involves the use of a CBM PETSCII control code, a reversed B, I represent this keystrokes with the text `{CTRL+B}`. Here's code for you to try:\
...
2. [UPDATE: 2022-03-13] ​Developer Bit Shifter was inspired by this post and companion video. After seeing the changes made from V7 to V10, and the way circles were created and their limitations, he has modified the code. Per Bit Shifter:
...
20 SPEED 1:GRAPHIC CLR:SCREEN 640,400,4
30 BOX 0,0,639,388
40 CHAR 13,382,2,2,2,"{CTRL+B} SUBMARINE TRACKING SYSTEM ",$29000
50 PEN 2
60 XR=10
70 DO
80 CIRCLE 160,95,XR
