...
30 line 100, 388, 0, 388, 0, 0, 639, 0, 639, 388, 540, 388
40 char 15, 380, 2, 2, 2, "submarine tracking system", $29000
50 pen 2 : xr = 20
60 do
70 circle 320, 190, xr
80 xr = xr + 20
90 loop until xr = 180
100 speed 40 : sleep 1
110 do
120 xr = 20
130 do
140 sound 1, 10000, 15
150 pen 1 : circle 320, 190 - xr, 4, 1
160 for x = 0 to 30000 : next
170 pen 0 : circle 320, 190 - xr, 4, 1
180 pen 0 : circle 320, 190, xr
190 pen 2 : circle 320, 190, xr
200 xr = xr + 20
210 sleep 1
220 loop until xr = 180
230 loop
```
**💾 On Disk:** [`MEGA65 Submarine Tracking System (High Resolution)`](https://www.stevencombs.com/images/c128/c128-sub-track-sys.txt)
