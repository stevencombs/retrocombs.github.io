...
![Adapter pinout to MEGA65](/images/mega65/mega65-uart-pinout-image.png)
...
![Voltage Jumper on UART](/images/mega65/mega65-uart-voltage-jumper.png)
...
My blog post, [Build MEGA65 Tools on MacOS X (Intel and M1) \| And an intro to the MEGA65 community](/mega65-tools), provides the instructions you need to install the MEGA65 command-line tools on your Intel and M1 Mac. 
