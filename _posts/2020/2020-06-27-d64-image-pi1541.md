...
You will see a directory listing that includes the new .d64 image and you can now use it like a 1541 disk drive.
...
One last reminder. As I've learned over time, SD cards, can be fragile. Make sure you have [many on hand](https://amzn.to/2BMxUVo) and back up your data regularly.
