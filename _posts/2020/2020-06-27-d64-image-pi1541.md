...
In my last [post](/pi1541-1) and [video](https://youtu.be/iiuS-cI2c6s), I shared my experience with the assembly and first use of a [Commodore4Ever](https://commodore4ever.net/) Pi1541 for the Raspberry Pi Zero. Not familiar with the device? Take look [here](https://commodore4ever.net/collections/drives/products/pidrive-zero-raspberry-pi-hat-1541-1581-commodore-64-128-vic-20-emulator-oled-pi1541) for more information.
